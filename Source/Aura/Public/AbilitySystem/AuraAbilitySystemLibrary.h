...
public:
	...
	static void GetLivePlayersWithinRadius(const UObject *WorldContextObject,TArray<AActor*>& OutActors,TArray<AActor*>& ActorsToIgnore,float Radius,const FVector &SphereOrigin);
};
